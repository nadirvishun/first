		...
		<div id="mysubcarousel" class="carousel slide" data-ride="carousel">
			...
			<div  class="carousel-inner smallcarousel">
				<div class="item active">
					<img  src="../img/ice/smallcarousel_ice_1.jpg"  alt="first slide">
				<div class="container">
				...
				<div class="item">
					<img src="../img/ice/smallcarousel_ice_1.jpg"  alt="second slide">
				<div class="container">
					<div class="carousel-caption">
						<h1>立方</h1>
						<p>just some words,I want say nothing!</p>
				...
				<div class="item">
					<img src="../img/ice/smallcarousel_ice_1.jpg"  alt="third slide">
				<div class="container">
					<div class="carousel-caption">
						<h1>心动</h1>
						<p>just some words,I want say nothing!</p>
        			...
        			<div id="<?=$category["type"];?>" class="tab-pane fade in active">
						<!--先显示全部商品-->
						<div class="row">
						<?foreach($xml->menu->category[1]->subcategory as $subcategory):?>
